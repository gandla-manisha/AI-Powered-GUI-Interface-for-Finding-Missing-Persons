...
class LoginWindow(QMainWindow):
    def __init__(self):
        ...
        self.initialize()
    def add_title(self):
        title_label = QLabel("Reunite: Missing Person Identification", self)  # Add the title text
        ...
        title_label.setGeometry(0, 50, self.width, 50)  # Position the title at the top, spanning the full width
